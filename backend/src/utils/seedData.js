...
const seedData = async () => {
  try {
    ...
    if (userCount === 0) {
      ...
      const events = eventRepository.create([
        {
          ...
          description: 'Join us for an exciting evening discussing Next.js App Router, Server Components, and state management.',
        ...
        },
        {
          ...
          description: 'A relaxed meetup to work on open-source projects, share ideas, and network with software engineers.',
      ...
      console.log('Database already contains data. Skipping seed step.');
    }
  } catch (error) {
